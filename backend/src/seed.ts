...
async function seed() {
  ...
  const chickenKing = await Restaurant.create({
    ...
    deliveryTimeMin: 25,
    deliveryTimeMax: 30,
    location: { type: "Point", coordinates: [106.7015, 10.7755] },
  ...
  const bunBoHue = await Restaurant.create({
    ...
    deliveryTimeMin: 15,
    deliveryTimeMax: 20,
    location: { type: "Point", coordinates: [106.6985, 10.7782] },
    address: "12 Pasteur",
    district: "Quận 1",
    city: "TP. Hồ Chí Minh",
    hasFreeShip: false,
  ...
  const bepViet = await Restaurant.create({
    ...
    deliveryTimeMin: 20,
    deliveryTimeMax: 30,
    location: { type: "Point", coordinates: [106.702, 10.777] },
    address: "88 Lê Lợi",
    district: "Quận 1",
    city: "TP. Hồ Chí Minh",
    hasFreeShip: true,
  ...
  const teaHouse = await Restaurant.create({
    ...
    deliveryTimeMin: 15,
    deliveryTimeMax: 25,
    location: { type: "Point", coordinates: [106.705, 10.774] },
    address: "22 Đồng Khởi",
    district: "Quận 1",
    city: "TP. Hồ Chí Minh",
    hasFreeShip: false,
    isPopular: false,
  ...
  const vouchers = await Voucher.insertMany([
    ...
    },
    {
      ...
      description: "Freeship đến 30.000đ",
      value: 30000,
    ...
    },
    {
      ...
      type: "cashback",
      title: "Hoàn 10% MoMo",
      description: "Cashback tối đa 20k khi thanh toán MoMo",
      value: 10,
      maxDiscount: 20000,
      minOrderAmount: 0,
      applicableTo: "all",
  ...
  const user = await User.create({
    ...
    addresses: [
      ...
      {
        label: "Văn phòng",
        fullAddress: "Bitexco Financial Tower, Quận 1",
        note: "",
        lat: 10.7719,
        lng: 106.7042,
        isDefault: false,
