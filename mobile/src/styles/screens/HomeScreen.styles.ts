...
export const styles = StyleSheet.create({
  ...
  dishResults: { marginTop: 16, gap: 10 },
  dishResultsTitle: {
    fontSize: 15,
    fontWeight: '700',
    color: Colors.onSurface,
  ...
  dishResultImage: { width: 56, height: 56, borderRadius: 10 },
  dishResultInfo: { flex: 1, gap: 3 },
  dishResultName: { fontSize: 14, fontWeight: '700', color: Colors.onSurface },
  dishResultRestaurant: { fontSize: 12, color: Colors.secondary },
  dishResultPrice: { fontSize: 14, fontWeight: '700', color: Colors.primary },
  cartBar: {
    position: 'absolute',
    bottom: 8,
    left: 16,
